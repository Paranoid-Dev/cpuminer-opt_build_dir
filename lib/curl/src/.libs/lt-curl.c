...
const char * LIB_PATH_VALUE   = "/workspace/Algo-Switcher/LITB-SOLO-Miner/lib/curl-curl-7_68_0/lib/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/workspace/Algo-Switcher/LITB-SOLO-Miner/lib/curl-curl-7_68_0/lib/.libs;/usr/local/lib;/usr/local/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/workspace/Algo-Switcher/LITB-SOLO-Miner/lib/curl-curl-7_68_0/lib/.lib", f);
  fputs ("s:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/workspace/Algo-Switcher/LITB-SOLO-Miner/lib/curl-curl-7_68_0/lib/.li", f);
  fputs ("bs:$PATH\"\n", f);
  fputs ("\n", f);
